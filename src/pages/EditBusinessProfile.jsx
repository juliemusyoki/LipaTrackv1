      ...
      <div className="px-5 pt-12 pb-28">
        <header className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Edit the details shown across LipaTrack.</p>
          </div>
        </header>
        ...
        <section className="rounded-2xl bg-green-700 text-white p-5 mb-5">
          ...
          <h2 className="text-xl font-bold">{businessName || "Your Business"}</h2>
          <p className="text-sm text-green-100 mt-2">
            This name appears on your homepage and profile.
          </p>
        </section>
        ...
        <form className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. RightSign Suppliers"
